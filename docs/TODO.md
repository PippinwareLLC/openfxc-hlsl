...
- [ ] Tests: unit/negative coverage for semantics/register forms, control flow, expression precedence; snapshot of an SM2/SM3 shader with intrinsics and sampler usage.
